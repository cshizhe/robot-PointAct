...
class KeyLUT:
    ...
    def _build_cpu_lut(self):
        device = torch.device("cpu")
        r256 = torch.arange(256, dtype=torch.int64, device=device)
        r512 = torch.arange(512, dtype=torch.int64, device=device)
        zero = torch.zeros(256, dtype=torch.int64, device=device)
