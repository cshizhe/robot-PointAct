...
# datasets
dataset=$1 # experiments/2_libero/data_configs/data-libero-spatial-point-frontview.yaml
...
output_dir=$SCRATCH/datasets/PointAct_exprs/libero/pointact/VLAEncDec3DWithActionRegressionModel-concerto-${run_name}-freeze.vlm
