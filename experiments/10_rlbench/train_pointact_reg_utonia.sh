...
dataset_name=keysteps-rot6d-points.frontview-no.image-aug.30
...
output_dir=$SCRATCH/datasets/PointAct_exprs/rlbench/hybridvla_10tasks/pointact/VLAEncDec3DWithActionRegressionModel-utonia-${run_name}-freeze.vlm
