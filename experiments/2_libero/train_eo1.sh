...
output_dir=$SCRATCH/datasets/PointAct_exprs/libero/eo1/${run_name}-freeze.vision.tower
...
# accelerate launch $ACCELERATE_ARGS -m kernprof -l -v scripts/train.py \
accelerate launch $ACCELERATE_ARGS scripts/train.py \
    --model_class EO1VisionFlowMatchingModel \
