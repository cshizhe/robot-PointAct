...
# datasets
dataset=experiments/2_libero/data_configs/data-libero-spatial-point-frontview.yaml
dataset_name=$(basename ${dataset%.*})-rot6d-image.frontview
...
output_dir=$SCRATCH/datasets/PointAct_exprs/libero/eo1_point/${run_name}-freeze.vision.tower
