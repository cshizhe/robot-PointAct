...
# datasets
dataset=experiments/10_rlbench/data_configs/data-hybridvla-point-frontview.yaml
dataset_name=keysteps-rot6d-points.frontview-no.image-aug.0
# dataset_name=keysteps-rot6d-4views.point.only-noarm 
...
output_dir=$SCRATCH/datasets/PointAct_exprs/rlbench/hybridvla_10tasks/pointact/VLAEncDec3DWithActionRegressionModel-${run_name}-freeze.vlm
...
accelerate launch $ACCELERATE_ARGS scripts/train.py \
    ...
    # --flow_matching_target v-pred \
    # --flow_matching_loss v-loss \

    # --action_head_centered_type none center
    # --ptv3_dec_channels 128 128 256 512 \
    # --ptv3_dec_depths 1 1 1 1 \
    # --ptv3_dec_num_head 4 4 8 16
    # --flow_matching_target x-pred \
    # --flow_matching_loss x-loss

    # --ptv3_dec_channels 128 128 256 512 \
    # --ptv3_dec_depths 1 1 1 1 \

    # --ptv3_enc_channels 64 128 256 384 512 \
    # --ptv3_enc_depths 2 2 2 2 2 \
    # --ptv3_enc_num_head 2 4 8 16 32 \

    # --ptv3_enc_channels 128 256 512 768 1024 \
    # --ptv3_enc_depths 2 2 2 2 2 \
    # --ptv3_enc_num_head 8 8 16 16 32 \
    ...
    # --ptv3_dec_channels 128 128 256 384 \
    # --ptv3_dec_depths 1 1 1 1

    # VLAEncDec3DRegressionModel 
    # VLAEncDec3DWithActionRegressionModel
    # VLAEncDec3DFlowMatchingModel
    # VLAEncDec3DMoEFlowMatchingModel
    # VLAEncDec3DWithActionStateConditionRegressionModel
    # VLAEncDec3DWithActionStateConcatRegressionModel
    # VLAEncDec3DWithActionFlowMatchingModel

    # --vision_spatial_merge_size 1
